...
$nonce=($_GET['nonce']);
$token = "test";
$key = "a5Uhuzo9MF2lo9JxtiqlhYQzoyyCioucBqWJCAaMEqH";
$cid = "wx07a6616a2553293f";
$Crypt = new WXBizMsgCrypt($token,$key,$cid);


$post_data=file_get_contents("php://input");
 
 $Crypt->DecryptMsg($msg_signature,$timestamp,$nonce,$post_data,$msg);

 $data=simplexml_load_string($msg,'SimpleXMLElement',LIBXML_NOCDATA);
 $reply_msg=<<<END
<xml>
<ToUserName><![CDATA[ { $data->FromUserName } ]]></ToUserName>
<FromUserName><![CDATA[{ $cid }]]></FromUserName>
